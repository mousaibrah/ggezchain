...
import { WeightedVoteOption } from "mousaibrah-ggezchain-client-ts/cosmos.gov.v1beta1/types"
import { TextProposal } from "mousaibrah-ggezchain-client-ts/cosmos.gov.v1beta1/types"
import { Deposit } from "mousaibrah-ggezchain-client-ts/cosmos.gov.v1beta1/types"
import { Proposal } from "mousaibrah-ggezchain-client-ts/cosmos.gov.v1beta1/types"
import { TallyResult } from "mousaibrah-ggezchain-client-ts/cosmos.gov.v1beta1/types"
import { Vote } from "mousaibrah-ggezchain-client-ts/cosmos.gov.v1beta1/types"
import { DepositParams } from "mousaibrah-ggezchain-client-ts/cosmos.gov.v1beta1/types"
import { VotingParams } from "mousaibrah-ggezchain-client-ts/cosmos.gov.v1beta1/types"
import { TallyParams } from "mousaibrah-ggezchain-client-ts/cosmos.gov.v1beta1/types"
