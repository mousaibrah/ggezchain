...
import GgezchainDenomfactory from './ggezchain.denomfactory'
import GgezchainTrade from './ggezchain.trade'
...
export default { 
  GgezchainDenomfactory: load(GgezchainDenomfactory, 'ggezchain.denomfactory'),
  GgezchainTrade: load(GgezchainTrade, 'ggezchain.trade'),
